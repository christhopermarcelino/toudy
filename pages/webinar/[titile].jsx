    ...
    <>
      ...
      <main className='px-2 mx-auto max-w-7xl sm:px-6 lg:px-8'>
        <section className='py-12 min-h-main space-y-6'>
          <h1 className='text-dark text-5xl'>Bincang Guru Inovatif</h1>
          <div className='md:flex space-x-8'>
            <div className='flex-1 relative md:w-4/5'>
              <Image
          ...
          <button className='bg-tertiary py-2 px-6 rounded-lg font-semibold text-lg'>
            Daftar Sekarang!
          </button>
        </section>
      </main>
